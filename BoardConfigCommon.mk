...
BOARD_CUSTOM_BOOTIMG_MK := device/lge/b1-common/releasetools/mkbootimg.mk
...
BOARD_BLUEDROID_VENDOR_CONF := device/lge/b1-common/bluetooth/vnd_g2.txt
...
# Recovery
#TARTGET_NO_RECOVERY := true
COMMON_GLOBAL_CFLAGS += -DNO_SECURE_DISCARD
TARGET_RECOVERY_FSTAB = device/lge/b1-common/rootdir/etc/fstab.g2
